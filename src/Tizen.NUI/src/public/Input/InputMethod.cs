...
namespace Tizen.NUI
{
    ...
    public class InputMethod
    {
        ...
        {
            PropertyMap outputMap = PropertyMap.GetReusable();

            if (panelLayout != null)
            {
                outputMap.AddInt("PANEL_LAYOUT", (int)panelLayout);
            }
            ...
            if (actionButton != null)
            {
                ...
                outputMap.AddInt("BUTTON_ACTION", (int)actionButton);
            }

            if (autoCapital != null)
            {
                outputMap.AddInt("AUTO_CAPITALIZE", (int)autoCapital);
            }
            if (variation != null)
            {
                outputMap.AddInt("VARIATION", (int)variation);
            }
            return outputMap;
        }
    }
