    ...
    public class Particle
    {
        ...
        public class StreamView
        {
            ...
            public static implicit operator Vector4(StreamView sv) {
                ...
                var ret = sv.mStreamIndex >= 0 ? Vector4.GetVector4FromPtr(Interop.Particle.ReadVector4(sv.mEmitterRef, (uint)sv.mStreamIndex, sv.mParticleIndex)) : Vector4.Zero;
                if (NDalicPINVOKE.SWIGPendingException.Pending)
                    throw NDalicPINVOKE.SWIGPendingException.Retrieve();
                return ret;
            }
        ...
        public Vector4 Color
        {
            get
            {
                ...
                var ret = Vector4.GetVector4FromPtr(Interop.Particle.ReadVector4(mEmitterRef, (uint)streamIndex, mIndex));
                if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
                return ret;
            }
            set
